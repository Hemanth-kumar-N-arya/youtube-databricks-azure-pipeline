...
deploy_resource("linkedservice", "ls_keyvault",           r"adf\linkedService\ls_keyvault.json")
deploy_resource("linkedservice", "ls_adls_gen2",          r"adf\linkedService\ls_adls_gen2.json")
deploy_resource("linkedservice", "ls_databricks",         r"adf\linkedService\ls_databricks.json")
deploy_resource("linkedservice", "ls_youtube_api",        r"adf\linkedService\ls_youtube_api.json")

deploy_resource("dataset", "ds_youtube_api_response",     r"adf\dataset\ds_youtube_api_response.json")
deploy_resource("dataset", "ds_adls_raw_json",            r"adf\dataset\ds_adls_raw_json.json")

deploy_resource("pipeline", "pl_youtube_batch_ingestion", r"adf\pipeline\pl_youtube_batch_ingestion.json")

deploy_resource("trigger",  "tr_daily_schedule",          r"adf\trigger\tr_daily_schedule.json")
